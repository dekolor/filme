    ...
    data: [
      {
        ...
        attributeIds: JSON.stringify(["2D", "EN"]),
        imdbId: "tt1234567",
      ...
      },
      {
        ...
        releaseYear: String(yesterday.getFullYear()),
        releaseDate: isoDate(yesterday),
        attributeIds: JSON.stringify(["2D", "RO"]),
        imdbId: "tt7654321",
      ...
      },
      {
        ...
        releaseYear: String(yesterday.getFullYear()),
        releaseDate: isoDate(yesterday),
        attributeIds: JSON.stringify(["3D", "EN"]),
        imdbId: null,
      ...
      },
      {
        ...
        attributeIds: JSON.stringify(["2D", "EN", "PREMIERE"]),
        imdbId: null,
        description:
    ...
    data: [
      {
        ...
        attributes: JSON.stringify(["SUB", "2D"]),
      ...
      },
      {
        ...
        attributes: JSON.stringify(["EN", "3D"]),
      ...
      },
      {
        ...
        attributes: JSON.stringify(["PREMIERE", "EN"]),
